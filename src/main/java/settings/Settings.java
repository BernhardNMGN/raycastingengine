...
public class Settings {
    ...
    public static final Double TEXTURE_SIZE = 256.;
    ...
    public static final Double MAX_TURNING_SPEED = FRAMERATE/1000.; // maximum player turning speed in degrees/second
    ...
    public static final Double MAX_DRAW_DISTANCE = SEGMENT_SIZE * 40.; // maximum distance a segment can be away from the player and still get rendered
